          ...
          contents: [
            {
              type: 'plain',
              text:
                "주식회사 게타(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          contents: [
            ...
            },
            {
              type: 'number',
              text:
                "필수 수집 정보: 아이디, 이메일 주소, 이름 및 연락처",
            },
            {
              type: 'number',
              text:
                "선택 수집 정보:  플랫폼 계정 정보(플랫폼 계정명, 프로필 사진, 연령, 성별)",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          contents: [
            ...
            },
            {
              type: 'number',
              text:
                "Amazon Web Services, Inc.에게 클라우드 인프라의 관리를 위하여 회원 탈퇴 시 혹은 위탁 계약 종료 시까지 개인정보처리를 위탁함",
            },
            {
              type: 'number',
              text:
          ...
          contents: [
            {
              type: 'plain',
              text:
                "쿠키 설치 허용 여부를 지정하는 방법, Internet Explorer의 경우는 다음과 같습니다.",
            },
            {
              type: 'number',
              text:
